...
BEGIN
  ...
  BEGIN TRY
	...
	PRINT '-----------------------------------------------------------';
	PRINT 'Loading Cleaned Data into CRM Tables';
	PRINT '-----------------------------------------------------------';
	...
	*, 
    ...
    PRINT '=====================================================';
	PRINT '>> Loading Cleaned Data into ERP Tables';
	PRINT '=====================================================';
	...
	SELECT
		   ...
		   ELSE cid
		   END AS cid, -- Remove NAS prefix for consistent cid

		   CASE 
			  WHEN bdate > GETDATE() THEN NULL
			  ELSE bdate
			  END AS bdate, -- Remove birthdate that are in the future
